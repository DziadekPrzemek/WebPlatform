...
var GcalEventSource = EventSource.extend({
	...
	buildRequestParams: function(start, end, timezone) {
		var apiKey = this.googleCalendarApiKey || this.calendar.opt('AIzaSyCS3gSmBiXSHBTPcEJGwEEa1dExY-l6aUs');
		var params;

		if (!apiKey) {
			this.reportError("AIzaSyCS3gSmBiXSHBTPcEJGwEEa1dExY-l6aUs");
			return null;
		}
